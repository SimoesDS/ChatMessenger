...
public interface ICommands {
  ...
  public static final int CONTACTS = 7; 		// Código requisitando a lista de contatos
  ...
  public static final int STATUS = 12; 		// Código de resposta do servidor, lista de status
